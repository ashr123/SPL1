...
file.write('CC=g++\n')
file.write('CFLAGS=-g -Wall -Weffc++ -std=c++11 -c -Iinclude -o\n')
...
file.write("\t@echo ''\n\t@echo -e '\\e[105m\\033[1;96mFinished building target: "+pName+"\\033[0m'\n\n")

for key in l.keys():
	file.write('bin/'+l[key]+': src/'+key+'\n')
	file.write("\t@echo -e '${GREEN}Compiling target: "+key+"${NC}'\n")
	file.write('\t$(CC) $(CFLAGS) bin/'+l[key]+' src/'+key+'\n')
	file.write("\t@echo ''\n\n")
